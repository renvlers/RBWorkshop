...
execute if score @s menu_status matches 1 run function builder_and_redstoner:actions/get_biome_brush
execute if score @s menu_status matches 2 run function builder_and_redstoner:actions/change_time_and_weather
